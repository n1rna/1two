			...
			Parameters: map[string]any{"type": "object", "properties": map[string]any{
				...
				"meals": map[string]any{"type": "array", "items": map[string]any{
					"type": "object", "properties": map[string]any{
						"day": map[string]any{"type": "string"}, "meal_type": map[string]any{"type": "string", "enum": []string{"breakfast", "lunch", "dinner", "snack"}},
						"name": map[string]any{"type": "string"}, "calories": map[string]any{"type": "integer"},
						"protein_g": map[string]any{"type": "integer"}, "carbs_g": map[string]any{"type": "integer"}, "fat_g": map[string]any{"type": "integer"},
