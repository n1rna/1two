...
export const SYNCABLE_KEYS: SyncableKeyDef[] = [
  { key: "1tt:calendar-markers", toolSlug: "calendar", label: "Calendar Markers", maxSizeBytes: 65536 },
  ...
  { key: "1tt-saved-logos", toolSlug: "logo", label: "Saved Logos", maxSizeBytes: 262144 },
  { key: "og-custom-layouts", toolSlug: "og", label: "OG Custom Layouts", maxSizeBytes: 262144 },
  { key: "1tt-saved-colors", toolSlug: "color", label: "Saved Colors", maxSizeBytes: 65536 },
  { key: "1tt-saved-themes", toolSlug: "color", label: "Saved Themes", maxSizeBytes: 65536 },
