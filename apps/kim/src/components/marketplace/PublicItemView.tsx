...
import { RoutineConfigReadonly } from "@/components/routines/routine-config-readonly";
import {
  defaultSchema,
  isRoutineConfigSchema,
} from "@/components/routines/routine-schema";
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-1">
        ...
        <div className="rounded-md border bg-muted/20 px-4 py-3">
          <RoutineConfigReadonly schema={schema} values={values} />
        </div>
      </div>
    </div>
  );
